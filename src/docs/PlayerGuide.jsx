...
const PlayerGuide = () => {
  return (
    <div className="doc-section">
      ...
      <section>
        <h2>📌 My Leagues</h2>
        <img src="/docs/user-modal.png" alt="League Section" className="doc-image" />
      ...
      <section>
        ...
        <img src="/docs/lineup.png" alt="Lineup Section" className="doc-image" />
      ...
      <section>
        <h2>💬 Offers Modal</h2>
        <img src="/docs/item-modal.png" alt="Offers Modal" className="doc-image" />
      ...
      <section>
        ...
        <img src="/docs/market.png" alt="Market Section" className="doc-image" />
      ...
      <section>
        ...
        <img src="/docs/offer-modal.png" alt="Offer Modal" className="doc-image" />
      ...
      <section>
        ...
        <img src="/docs/mvps.png" alt="MVPs Section" className="doc-image" />
